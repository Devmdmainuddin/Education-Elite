...
const ScholarshipItems = ({item}) => {
    const {ScholarshipName,UniversityName,SubjectCategorey,Degree,location,ScholarshipCategory,postDate,ApplicationDeadline,image,ApplicationFees,PostedBy,_id}=item
